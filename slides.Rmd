...
subtitle: ""
author: "François Michonneau, <br> Gustav Paulay, Mark Martindale"
date: "June 4th, 2018"
output:
...
to document and understand the impact of human activites

- What are the impacts of perturbations, pollution?
- Which species are invasive?
- How does global change affect biological communities?

--

### Invertebrates represent 75+% of the marine diversity
...
# Synthesize current knowledge of US marine invertebrates biodiversity
...
#### 2. Identify digitization and knowledge gaps
...
* 244,090 museum records from iDigBio (11,362 species, 26 phyla)
* 1,353,861 occurence records from OBIS (14,907 species, 28 phyla)

--

### 16,939 species in the US
...
plot_sampling_effort(combined_data_map_standardized_diversity)
```
...
Comparison with taxonomic checklists
...
# 20% of the species have DNA barcodes available
...
bold_data %>%
    dplyr::filter(data_source=="all_idigbio") %>%
    ggplot(aes(x = factor(phylum, levels = plot_order), y = p_has_bold, fill=phylum)) +
...
### Invest in sampling and taxonomic training
